export const knowCodeToolSpecs = [
    {
        ...
        description: 'Check the health of the FalkorDB graph index, total code files, symbols, call edges, documentation sections, architecture rules, and background daemon status. Run this once per session before starting complex refactoring or navigation tasks to verify index freshness.',
        parameters: {},
        action: 'status',
    ...
    },
    {
        ...
        description: 'Trigger an on-demand incremental re-index of newly added or modified files across the workspace into the FalkorDB graph. Call this after editing or adding files if the background daemon is offline or after large batch code modifications to ensure graph accuracy.',
        parameters: {},
        action: 'sync',
    ...
    },
    {
        ...
        description: 'Detect circular import or call dependency loops between files, packages, and modules using FalkorDB cycle traversal. Crucial when modularizing monolithic codebases, breaking tight coupling, or preparing for language ports (e.g. Go and Rust strictly forbid circular package imports).',
        parameters: {},
    ...
    },
    {
        ...
        description: 'Identify unreferenced internal/private symbols with 0 incoming calls in the codebase. Helps developers and agents safely eliminate dead code, ghost helper functions, and unused declarations during technical debt cleanups.',
        parameters: {
            limit: {
                type: 'number',
